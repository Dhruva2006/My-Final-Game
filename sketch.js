...
function draw() {
  ...
  if(gameState == END) {
    ...
    player.changeAnimation("A", Man1_Dead1);
    player.scale = 3;
    ...
    // enemyBullet1.destroyEach();
    // enemyBullet2.destroyEach();
    // enemyBullet3.destroyEach();
    // enemyBullet4.destroyEach();
...
function Enemy() {
  ...
  function enemy1() {
    if(frameCount % 100 == 0) {
      ...
      enemyBullet1.addImage(bullet2);
      enemyBullet1.scale= 0.1;
  ...
  function enemy4() {
    if(frameCount % 1000 ==0) {
      ...
      enemyBullet4.addImage(bullet2);
      enemyBullet4.scale= 0.1;
